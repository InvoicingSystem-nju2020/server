...
public class UpdateSingleGoodsBean {
    ...
    public UpdateSingleGoodsBean(){

    }

    public UpdateSingleGoodsBean(String _goodsNumber,String _goodsName, String _abbreviation,
                                 ...
                                 String _placeOfProduction, int _qualityGuaranteePeriod, String _remarks){
    ...
    public void setQualityGuaranteePeriod(int _qualityGuaranteePeriod){
        this.qualityGuaranteePeriod = _qualityGuaranteePeriod;
    }
