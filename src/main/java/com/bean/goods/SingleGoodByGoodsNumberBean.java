...
public class SingleGoodByGoodsNumberBean {
    ...
    public SingleGoodByGoodsNumberBean(){

    }

    public SingleGoodByGoodsNumberBean(String _goodsNumber,String _goodsName, String _abbreviation,
