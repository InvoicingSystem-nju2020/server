...
public class SuppliersReturnListBean {
    ...
    public SuppliersReturnListBean(){

    }

    public SuppliersReturnListBean(String _supplierNumber, String _supplierName, String _contactInformation,
