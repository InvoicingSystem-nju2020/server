...
public class UpdateSingleClientBean {
    ...
    public UpdateSingleClientBean(){

    }

    public UpdateSingleClientBean(String _clientsNumber, String _clientsName, String _clientsType,
                                   String _clientsContact, String _clientsSex, String _clientsPost,
